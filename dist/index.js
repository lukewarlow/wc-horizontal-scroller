...
class x extends HTMLElement {
  ...
  constructor() {
    ...
    n.adoptedStyleSheets.push(w), this.#e = n, n.appendChild(b.content.cloneNode(!0)), this.#o = this.attachInternals();
  }
  #r = (n) => {
